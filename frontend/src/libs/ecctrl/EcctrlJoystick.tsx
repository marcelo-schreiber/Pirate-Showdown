...
const JoystickComponents = (props: EcctrlJoystickProps) => {
  ...
  const joystickDiv: null | HTMLDivElement =
  ...
  const onTouchMove = useCallback(
    (e: TouchEvent) => {
      ...
      const runState =
        joystickDis.current >
        joystickMaxDis.current * (props.joystickRunSensitivity ?? 0.9);
...
const ButtonComponents = ({
  ...
  const buttonDiv: null | HTMLDivElement =
    document.querySelector("#ecctrl-button");
