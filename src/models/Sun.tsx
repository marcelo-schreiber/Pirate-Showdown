...
export function Sun() {
  ...
  const {
    ...
    intensity: { value: 6.2, min: 0, max: 5, step: 0.1 },
    posX: { value: -150, min: -200, max: 200, step: 1 },
    posY: { value: 100, min: 0, max: 200, step: 1 },
    posZ: { value: 0, min: -200, max: 200, step: 1 },
    camLeft: { value: -150, min: -300, max: 0, step: 1 },
    camRight: { value: 150, min: 0, max: 300, step: 1 },
    camTop: { value: 80, min: 0, max: 300, step: 1 },
    camBottom: { value: -83, min: -300, max: 0, step: 1 },
    camNear: { value: 50, min: 0.1, max: 50, step: 0.1 },
    camFar: { value: 300, min: 50, max: 1000, step: 1 },
